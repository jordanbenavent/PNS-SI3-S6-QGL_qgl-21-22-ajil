...
class CalculDeplacementTest {
    ...
    void distanceTest(){
        ...
        Assertions.assertEquals(40, strategie.getCalculDeplacement().distance(checkpoint, ship));
        ship.getPosition().setX(50);
        Assertions.assertEquals(10 * Math.sqrt(17), strategie.getCalculDeplacement().distance(checkpoint, ship));
    }
    ...
    void predictionAngleTourSuivantTest(){
        ...
        deplacements = strategie.getCalculDeplacement().predictionAngleTourSuivant(v_ship, v_check, checkpoint);
    ...
    void nbrSailorsNecessairesTest(){
        ...
        Assertions.assertEquals(2, strategie.getGestionMarins().nbrSailorsNecessaires(jeu.getShip().getOars().size(), 55));
        // On tourne à un angle de PI/2
        Assertions.assertEquals(3, strategie.getGestionMarins().nbrSailorsNecessaires(jeu.getShip().getOars().size(), 82.5));
    }
    ...
    void ramerSelonVitesseTest(){
        ...
        jeu.getSailors().add(sailor3); jeu.getSailors().add(sailor4);
